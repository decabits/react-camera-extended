...
class Camera extends Component {
  ...
  render() {
    return (
      <div style={ window.Object.assign({}, this.props.styles.videoContainer || {}, styles.default.videoContainer) } ref={(videoContainer) => { this.videoContainer = videoContainer; }}>
        { this.props.children }
        <canvas ref={(canvas) => { this.canvas = canvas; }}></canvas>
        <video style={ window.Object.assign({}, this.props.styles.video || {}, styles.default.video) } ref={(video) => { this.video = video; }} />
      </div>
    );
  }
}
